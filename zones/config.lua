Config = {
    Greenzones = {
        ["sspd"] = {
            location = {x = 305.301, y = -586.74, z = 44.25},
            diameter = (15 * 3.14159), -- the maximum width of the sphere. this is also the width on ground level. Multiply this by 3.14159 to have a better looking sphere, It's not required to do that however.
